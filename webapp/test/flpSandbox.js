		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reuse Component UI",
									"targetURL": "#comndbsreusecomponentui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comndbsreusecomponentui-display": {
								"semanticObject": "comndbsreusecomponentui",
								"action": "display",
								"description": "Reuse Component UI",
								"title": "Reuse Component UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ndbs.reusecomponentui",
									"url": sap.ui.require.toUrl("com/ndbs/reusecomponentui")
								}
							}
						}
					}
